<div class="signals-tile" id="pro">
  <div class="signals-tile-body">
    ...
    <p>PRO version of the plugin gives you access to numerous <a href="<?php echo csmm_generate_web_link('pro-header', '/features/'); ?>"
        target="_blank">advanced features</a> including best-in-class SEO options, gallery of 950,000+ images, 100+ themes, 10+ page modules, and
...
?>
      ...
      <table id="features-table">
        <tr>
          ...
          <td>
            <div class="home-box"><span>950,000+ Premium Hi-Resolution Images</span>
